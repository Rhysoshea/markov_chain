This is an implementation of a markov chain python script to generate random text based on contect provided by the user.

# markov_python
Codecademy Markov Chain text generator module.
This is an implementation of a [Markov Chain](https://en.wikipedia.org/wiki/Markov_chain).
